...
void MemoryBlockchainStorage::saveBlock(const chrono_ledger::Block& block) {
...
void MemoryBlockchainStorage::saveMetadata(const chrono_util::Bytes& key, const chrono_util::Bytes& value) {
